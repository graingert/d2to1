...
MANIFEST_MARKER = '# Temporarily generated by d2to1. Please delete.\n'
...
def cfg_to_args(path='setup.cfg'):
    ...
    if extra_files:
        ...
        try:
            log.info("writing manifest file (d2to1) %r" % MANIFEST_FILENAME)
            manifest_file.write(MANIFEST_MARKER)
            for line in split_multiline(extra_files):
...
def remove_manifest():
    ...
    try:
        ...
        manifest_file.close()
    if MANIFEST_MARKER in manifest_content:
        log.info("deleting manifest file (d2to1) %r" % MANIFEST_FILENAME)
